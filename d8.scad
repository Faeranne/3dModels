...
#linear_extrude(height=.1){
  scale(0.05) import(str("./iconography/",types[7-i],".dxf"));
  translate([0,0.45,0]) scale(0.3) text(text = str(numbers[7-i]), font = font, size = fontsize, halign = "center", valign = "center");
}
...
linear_extrude(height=.1){
  scale(0.05) import(str("./iconography/",types[i],".dxf"));
  translate([0,0.45,0]) scale(0.3) text(text = str(numbers[i]), font = font, size = fontsize, halign = "center", valign = "center");
}
                                        }
                                    }
                                }
